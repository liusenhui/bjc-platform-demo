<template>
  <div>
    <div>
      <el-col :span="6" class="info el-font-size">
        <div class="info-box">
          <div class="info-box-icon bg-aqua"><i class="fa fa-cog"></i></div>
      ...
      <el-col :span="6" class="info">
        <div class="info-box">
          <div class="info-box-icon bg-red"><i class="fa fa-google-plus"></i></div>
          <div class="info-box-content">
            <span>关注数</span>
            <span class="info-box-number">36680</span>
          </div>
        </div>
      </el-col>
      <el-col :span="6" class="info">
        <div class="info-box">
          <div class="info-box-icon bg-green"><i class="fa fa-internet-explorer"></i></div>
          <div class="info-box-content">
            <span>英特网</span>
            <span class="info-box-number">660</span>
          </div>
        </div>
      </el-col>
      <el-col :span="6" class="info">
        <div class="info-box">
          <div class="info-box-icon bg-yellow"><i class="fa fa-users"></i></div>
          <div class="info-box-content">
            <span>新用户</span>
